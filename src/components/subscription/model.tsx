...
const Model: React.FC<ModelProps> = ({
  ...
  return (
    <div
      className={`bg-white rounded-none border p-6 flex flex-col justify-between ${
        highlight ? "bg-gray-100" : ""
      }`}
    >
      {/* Badge */}
      <div className="mb-4">
        <span className="bg-btn-primary text-white text-xs font-semibold px-2 py-1 rounded-none">
          {title.toUpperCase()}
        </span>
      </div>
